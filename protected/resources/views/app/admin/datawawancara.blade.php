...
<div class="container container-app">
  ...
  <div class="row">
    <div class="col-md-12 card-table">
			<table id="data-wawancara" class="display table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
  			 ...
  			 <div class="panel-body">
  				 <div class="alert alert-success">
  					...
  					<div class="col-md-6 form-group">
  						...
  						<input class="input form-control col-md-4" type="text" name="pesan_sukses" id="jadwal-pengambilan" readonly>
  					</div>
  			 </div>
  		 </div>
  	 </div>
